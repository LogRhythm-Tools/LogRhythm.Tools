...
Function Disable-LrtADAccount {
    <#
    .SYNOPSIS
        Invokes the ActiveDirectory module command Disable-ADAccount for LrtAD cmdlets.
    .DESCRIPTION
        The purpose of the Disable-LrtADAccount command is to serve as a simple wrapper to manage
    ...
    .EXAMPLE
        PS C:\> Disable-LrtADAccount -Identity "bobjones"
    .LINK
